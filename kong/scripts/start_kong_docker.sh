...
# https://blog.csdn.net/gw5205566/article/details/102370452
...
# 
# mkdir -p $HOME/kong/config
# cp kong.yml $HOME/kong/config


# delete the service if duplicate
# curl -X DELETE "http://localhost:8001/services/admin-api"

# copy kong.yml to $HOME/kong/config before run below command
